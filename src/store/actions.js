...
export const TOGGLE_WORK_BREAK_INTERVAL_ACTION = "toggle_work_break_interval_action";
...
export const dispatchToggleWorkBreakIntervalAction = () => ({ type: TOGGLE_WORK_BREAK_INTERVAL_ACTION });